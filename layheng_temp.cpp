...
void a::Customer_Transaction_History()
{
    ...
    string fromAcc, fromName, toAcc, toName, amountTransferred, date;
    int i = 0;
    ...
    bank1.ignore();
    getline(bank1, amountTransferred);
    bank1.ignore();
    getline(bank1, date);
    ...
    while (!bank1.eof())
    {
        ...
        if (targetedAcc == accTransferred || targetedAcc == accReceived)
        {
            ...
            cout << setw(171) << setfill('-') << "" << endl;
            cout << "|" << setw(4) << setfill(' ') << i + 1 << setw(4) << setfill(' ') << "|";
            cout << setw(internal_fromAcc + fromAcc.length()) << accTransferred << setw(47 - (internal_fromAcc + fromAcc.length())) << "|";
            cout << setw(internal_toAcc + toAcc.length()) << accReceived << setw(50 - (internal_toAcc + toAcc.length())) << "|";
            cout << setw(internal_date + date.length()) << date << setw(45 - (internal_date + date.length())) << "|";
            cout << setw(internal_amount + amountTransferred.length()) << amountTransferred << setw(20 - (internal_amount + amountTransferred.length())) << "|";
            cout << endl;
            i++;
        }
